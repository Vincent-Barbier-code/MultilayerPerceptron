...
def train(train_data: pd.DataFrame, validation_data: pd.DataFrame) -> None:
    ...
    neural.train(train_data.values, train_true.values, validation_data.values, validation_true.values)
